 ...
 * 
 */
package pers.yangws.androiddevtools.androiddevtools.adapter;
...
public abstract class BasisExpandaListAdapter<E,T> extends BaseExpandableListAdapter{
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView != null) {
			...
			mGroupHolder = (BaseHolder<E>) getGroupHolder(groupPosition, isExpanded, convertView, parent);
		}
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (convertView != null) {
			...
			mChildHolder = (BaseHolder<T>) getChildHolder(groupPosition, childPosition, isLastChild, convertView, parent);
		}
